...
STUDENT_LIBS_LATE = libsyscall.a libatomic.a
...
PROGS = $(410REQPROGS) $(STUDENTREQPROGS) \
	$(410TESTS) $(STUDENTTESTS) \
...
print:
	enscript -2rG -fCourier7 -FCourier-Bold10 -p $(PRINTOUT) \
		$(if $(strip $(TABSTOP)),-T $(TABSTOP),) \
			`find ./user/ -type f -regex  '.*\.[chS]' | sort`

handin: clean
	@tar cvzf handin.tar.gz $(STUUDIR)/
	@echo "***"
